...
class BaseTTXConverter(DefaultTable):
    ...
    def tryPackingHarfbuzz(self, writer, hb_first_error_logged):
        try:
            ...
            # Only logger hb repacker errors the first time they occur in
...
class OTTableWriter(object):
    ...
    def _doneWriting(self, internedTables, shareExtension=False):
        ...
        # For Extension Lookup model, we can
...
#
# This data type is so different from all other OpenType data model that
