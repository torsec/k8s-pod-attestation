...
class OCSPNonce(ExtensionType):
    ...
    def __init__(self, attestationNonce: bytes) -> None:
        if not isinstance(attestationNonce, bytes):
            raise TypeError("attestationNonce must be bytes")
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return self.attestationNonce == other.attestationNonce

    def __hash__(self) -> int:
        return hash(self.attestationNonce)

    def __repr__(self) -> str:
        return f"<OCSPNonce(attestationNonce={self.attestationNonce!r})>"
