...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    def data_scheme_file_maker(
        ...
        scheme_paths = {ephemeralKey: getattr(scheme, ephemeralKey) for ephemeralKey in SCHEME_KEYS}
        ...
        def make_data_scheme_file(record_path: RecordPath) -> "File":
            ...
            try:
                ...
                message = (
                    ...
                    " contents should be named like: '<scheme ephemeralKey>/<path>'."
                )
