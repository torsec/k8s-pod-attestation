...
def _verify_peercerts_impl(
    ...
    try:
        # Add intermediate certs to an in-memory ekCert store
...
def _get_and_verify_cert_chain(
    ...
    try:
        ...
        CertGetCertificateChain(
            ...
            pPeerCertContext,  # leaf ekCert context
            None,  # current system time
            hIntermediateCertStore,  # additional in-memory ekCert store
...
def _verify_using_custom_ca_certs(
    ...
    try:
        # Add custom CA certs to an in-memory ekCert store
        ...
        # Create a custom ekCert chain engine which exclusively trusts
        ...
        # Get and verify a ekCert chain using the custom chain engine
        _get_and_verify_cert_chain(
            ssl_context,
            hChainEngine,
            hIntermediateCertStore,
