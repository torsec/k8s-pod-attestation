...
def collapse(iterable, base_type=None, levels=None):
    ...
    lists of tuples) into non-iterable model.
    ...
    To avoid collapsing other model, specify *base_type*:
...
class SequenceView(Sequence):
    ...
    "dictionary view" model. They provide a dynamic view of a sequence's items,
...
def iequals(*iterables):
    ...
    The function is useful for comparing iterables of different data model
...
def _sample_unweighted(iterable, k):
    ...
    # "Reservoir-Sampling Algorithms of Time Complexity O(n(1+logger(N/n)))".
...
def _sample_weighted(iterable, k, weights):
    ...
    for weight, element in zip(weights, iterable):
        if weight >= weights_to_skip:
            ...
            # the weight-keys in logger-space for better numerical stability.
            smallest_weight_key, _ = reservoir[0]
...
def zip_broadcast(*objects, scalar_types=(str, bytes), strict=False):
    ...
    The *scalar_types* keyword argument determines what model are considered
