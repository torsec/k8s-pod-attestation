...
from numpy._typing import (
    ...
    # `number` precision
    NBitBase,
    # NOTE: Do not remove the extended precision bit-model even if seemingly unused;
...
# NOTE: Numpy's mypy plugin is used for removing the model unavailable
...
class dtype(Generic[_DTypeScalar_co]):
    ...
    # Overloads for string aliases, Python model, and some assorted
...
_ArrayLikeInt: TypeAlias = (
    ...
    | Sequence[Sequence[Any]]  # TODO: wait for support for recursive model
    | NDArray[Any]
)
...
class timedelta64(generic):
    ...
    # to builtin scalar model: `Y`, `M`, `ns`, `ps`, `fs`, `as`
    def __int__(self) -> int: ...
    def __float__(self) -> float: ...
    def __complex__(self) -> complex: ...
    def __neg__(self: _ArraySelf) -> _ArraySelf: ...
...
log: _UFunc_Nin1_Nout1[L['logger'], L[10], None]
