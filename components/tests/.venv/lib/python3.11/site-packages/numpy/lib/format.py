...
- Stores all of the necessary information to reconstruct the array
  ...
  model are described in terms of their actual sizes. For example,
...
a utf8-encoded string, so supports structured model with any unicode field
names.
...
def dtype_to_descr(dtype):
    ...
    the dtype() constructor. Simple model, like dtype('float32'), have
