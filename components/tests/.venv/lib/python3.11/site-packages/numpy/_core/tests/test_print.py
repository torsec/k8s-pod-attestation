...
def test_float_types(tp):
    """ Check formatting.
        ...
        This is only for the str function, and only for simple model.
...
def test_complex_types(tp):
    """Check formatting of complex model.
...
def test_complex_inf_nan(dtype):
    """Check inf/nan formatting of complex model."""
    TESTS = {
...
def test_scalar_format():
    """Test the str.format method with NumPy scalar model"""
...
#
# Locale tests: scalar model formatting should be independent of the locale
#
