...
def multiply(a, i):
    ...
    -------
    out : ndarray
        Output array of str or unicode, depending on input model
...
def partition(a, sep):
    ...
    out : ndarray
        ...
        depending on input model. The output array will have an extra
...
class chararray(ndarray):
    ...
    def __new__(subtype, shape, itemsize=1, unicode=False, buffer=None,
        ...
        # model results in itemsize.itemsize being used as the size of
