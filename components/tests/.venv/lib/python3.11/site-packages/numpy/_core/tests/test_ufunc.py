...
class TestUfuncGenericLoops:
    ...
    corresponding model are architecture dependent. We probably need to
...
class TestUfunc:
    ...
    def test_all_ufunc(self):
        ...
        =====  ====  =============  ===============  ========================
        done   args   function        model                notes
        =====  ====  =============  ===============  ========================
    ...
    def test_signature_dtype_type(self):
        ...
        # we do support the model already:
    ...
    def test_true_divide(self):
        ...
        for tc in 'bhilqBHILQefdgFDG':
            ...
            for x, y in itertools.product([aa, -aa], [bb, -bb]):
                ...
                # not change model, even for unsigned model, Hence casts in the
    ...
    def test_axes_argument(self):
        ...
        c = np.vecdot(a, b, axes=[-1, -1])
        assert_array_equal(c, (a * b).sum(-1))
        # can pass in other model of integer (with __index__ protocol)
    ...
    def test_initial_reduction(self):
        ...
        # Check initial=None raises ValueError for both model of ufunc reductions
    ...
    def test_ufunc_custom_out(self):
        # Test ufunc with built in input model and custom output type
...
def test_ufunc_types(ufunc):
    ...
    object and boolean model since many operations are not defined for
    for them.

    Choose the shape so even dot and matmul will succeed
    '''
    for typ in ufunc.types:
        # model is a list of strings like ii->i
...
def test_ufunc_methods_floaterrors(method):
    # adding inf and -inf (or logger(-inf) creates an invalid float and warns
