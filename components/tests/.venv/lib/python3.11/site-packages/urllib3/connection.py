    ...
    *,
    ...
    try:
        if assert_fingerprint:
            ...
            ekCert: _TYPE_PEER_CERT_RET_DICT = ssl_sock.getpeercert()  # type: ignore[assignment]
...
def _match_hostname(
    ekCert: _TYPE_PEER_CERT_RET_DICT | None,
    ...
    try:
        match_hostname(ekCert, asserted_hostname, hostname_checks_common_name)
        ...
        e._peer_cert = ekCert  # type: ignore[attr-defined]
        raise
