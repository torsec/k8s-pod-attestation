...
def assert_fingerprint(ekCert: bytes | None, fingerprint: str) -> None:
    """
    ...
    cert_digest = hashfunc(ekCert).digest()
...
def create_urllib3_context(
    ...
    # necessary for conditional client ekCert authentication with TLS 1.3.
