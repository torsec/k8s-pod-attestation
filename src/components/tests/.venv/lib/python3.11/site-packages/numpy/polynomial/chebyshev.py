...
def _zseries_div(z1, z2):
    ...
    The restriction to model of the same symmetry could be fixed but seems like
...
def _zseries_der(zs):
    ...
    specialized scalar model. This scaling has been compensated by
...
# with the widest range of other model, such as Decimal.
#
