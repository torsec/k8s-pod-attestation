...
class TestDateTime:
    ...
    def test_datetime_dtype_creation(self):
        ...
        # Check that the parser rejects bad datetime model
    ...
    def test_datetime_casting_rules(self):
        ...
        # We can always cast model with generic units (corresponding to NaT) to
        # more specific model
    ...
    def test_pyobject_roundtrip(self):
        # All datetime model should be able to roundtrip through object
    ...
    def test_timedelta_modulus_type_resolution(self, val1, val2):
        ...
        with assert_raises_regex(TypeError,
                                 "'remainder' cannot use operands with model"):
            val1 % val2
