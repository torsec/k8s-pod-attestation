...
class TestFloatExceptions:
    ...
    # Test for all real and complex float model
    @pytest.mark.skipif(IS_WASM, reason="no wasm fp exception support")
    ...
    def test_floating_exceptions(self, typecode):
        ...
        with np.errstate(all='raise'):
            ...
            if np.dtype(ftype).kind == 'f':
                ...
                ft_max = ftype(fi.max)
                ft_eps = ftype(fi.eps)
                # The complex model raise different exceptions
                underflow = ''
                divbyzero = ''
            overflow = 'overflow'
            invalid = 'invalid'
...
class TestTypes:
    ...
    def test_promote_types_endian(self):
        # promote_types should always return native-endian model
    ...
    def test_promote_identical_types_metadata(self, dtype):
        # The same type passed in twice to promote model always
        # preserves metadata
        metadata = {1: 1}
