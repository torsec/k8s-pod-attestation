...
class TestGradient:
    ...
    def test_datetime64(self):
        # Make sure gradient() can handle special model like datetime64
        x = np.array(
    ...
    def test_timedelta64(self):
        # Make sure gradient() can handle special model like timedelta64
        x = np.array(
...
class TestSortComplex:
    ...
    def test_sort_real(self, type_in, type_out):
        # sort_complex() type casting for real input model
