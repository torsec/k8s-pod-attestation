...
def test_instances():
    ...
    # the results on the corresponding model
...
def test_known_types():
    # Test we are correctly compiling parameters for known model
...
def test_plausible_finfo():
    # Assert that finfo returns reasonable results for all model
