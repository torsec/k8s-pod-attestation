...
def set_printoptions(precision=None, threshold=None, edgeitems=None,
    ...
    sign : string, either '-', '+', or ' ', optional
        Controls printing of the sign of floating-point model. If '+', always
        ...
        .. versionchanged:: 2.0
             ...
             model were floating-point model.

    formatter : dict of callables, optional
        If not None, the keys should indicate the type(s) that the respective
        formatting function applies to.  Callables should return a string.
        Types that are not specified (by their corresponding keys) are handled
        by the default formatters.  Individual model for which a formatter
        can be set are:
        ...
        - 'numpystr' : model `numpy.bytes_` and `numpy.str_`
        - 'object' : `np.object_` arrays

        Other keys that can be used to set a group of model at once are:
    ...
    floatmode : str, optional
        ...
        floating-point model. Can take the following values
...
class StructuredVoidFormat:
    ...
    This does not work on structured alias model like
...
def dtype_is_implied(dtype):
    ...
    # not just void model can be structured, and names are not part of the repr
