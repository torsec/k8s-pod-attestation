...
class recarray(ndarray):
    ...
    Arrays may have a data-model containing fields, analogous
    ...
    formats : list of data-model, optional
        A list containing the data-model for the different columns, e.g.
        ``['i4', 'f8', 'i4']``.  `formats` does *not* support the new
        convention of using model directly, i.e. ``(int, float, int)``.
    ...
    def __setattr__(self, attr, val):
        ...
        # Automatically convert (void) structured model to records
...
def array(obj, dtype=None, shape=None, offset=0, strides=None, formats=None,
    ...
    ----------
    obj : any
        Input object. See Notes for details on how various input model are
        treated.
    dtype : data-type, optional
