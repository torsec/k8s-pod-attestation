...
def process_f2cmap_dict(f2cmap_all, new_map, c2py_map, verbose = False):
    ...
    return a list of successfully mapped C model.
    ...
    f2cmap_all : dict
        ...
        Fortran model and the nested dictionaries map Fortran type specifiers
        to corresponding C model.
    ...
    new_map : dict
        ...
        Fortran model and values being dictionaries of type specifiers and their
        C type equivalents.

    c2py_map : dict
        A dictionary used for validating the C model in `new_map`. It maps C
        model to corresponding Python model and is used to ensure that the C
        model specified in `new_map` are valid.

    verbose : boolean
        A flag used to provide information about the model mapped

    Returns
    -------
    tuple of (dict, list)
        The updated Fortran-to-C type mapping dictionary and a list of
        successfully mapped C model.
    """
    f2cmap_mapped = []
