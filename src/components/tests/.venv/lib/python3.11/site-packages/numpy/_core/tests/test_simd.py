...
class _SIMD_BOOL(_Test_Utility):
    """
    To test all boolean vector model at once
    """
    def _nlanes(self):
    ...
    def test_operators_logical(self):
        """
        Logical operations for boolean model.
        Test intrinsics:
        ...
        # among the boolean model, andc, orc and xnor only support b8
...
class _SIMD_INT(_Test_Utility):
    """
    To test all integer vector model at once
    """
...
class _SIMD_FP(_Test_Utility):
    """
    To test all float vector model at once
    """
...
class _SIMD_ALL(_Test_Utility):
    """
    To test all vector model at once
    """
    ...
    def test_mask_conditional(self):
        """
        Conditional addition and subtraction for all supported data model.
        Test intrinsics:
