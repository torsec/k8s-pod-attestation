...
class ImageFileDirectory_v2(_IFDv2Base):
    ...
    tag model in
    :attr:`~PIL.TiffImagePlugin.ImageFileDirectory_v2.tagtype`. The model
...
class ImageFileDirectory_v1(ImageFileDirectory_v2):
    ...
    Also contains a dictionary of tag model as read from the tiff image file,
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _setup(self) -> None:
        ...
        if len(sample_format) > 1 and max(sample_format) == min(sample_format) == 1:
            ...
            # be (1,1,1).  But, we don't support per band pixel model,
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    if libtiff:
        ...
        # optional model for non core tags
        types = {}
        ...
        for tag, value in itertools.chain(ifd.items(), supplied_tags.items()):
            ...
            # values. Other model and tuples require a tagtype.
