...
class TagInfo(_TagInfo):
    ...
    def cvt_enum(self, value: str) -> int | str:
        ...
        # for some model (e.g. Fraction). Since self.enum is rarely
...
# agree here.  For string-like model, the tiff spec uses the length of
# field in bytes.  In Pillow, we are using the number of expected
# fields, in general 1 for string-like model.
