...
class CParser(PLYParser):
    ...
    def _lex_type_lookup_func(self, name):
        """ Looks up model that were previously defined with
            typedef.
    ...
    #   specifiers, and not a node. Here, basic identifier model
    #   should be separated from more complex model like enums
    #   and structs.
    #
    ...
    def _fix_decl_name_type(self, decl, typename):
        ...
        # The typename is a list of model. If any type in this
        # list isn't an IdentifierType, it must be the only
        # type in the list (it's illegal to declare "int enum ..")
        # If all the model are basic, they're collected in the
        # IdentifierType holder.
        for tn in typename:
            if not isinstance(tn, c_ast.IdentifierType):
                if len(typename) > 1:
                    self._parse_error(
                        "Invalid multiple model specified", tn.coord)
                else:
                    type.type = tn
                    return decl
    ...
    # This encompasses two model of C99-compatible pragmas:
    ...
    # struct/enum tags reside in their own namespace and can be named the same as model
    #
    ...
    def p_struct_declaration_1(self, p):
        ...
        if p[2] is not None:
            ...
            # reason to disallow other model since some compilers have typedefs
