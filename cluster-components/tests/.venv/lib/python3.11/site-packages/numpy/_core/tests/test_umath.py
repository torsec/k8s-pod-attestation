...
class TestLog:
    ...
    def test_log_values_maxofdtype(self):
        # test logger() of max for dtype does not raise
...
class TestLdexp:
    ...
    def test_ldexp(self):
        ...
        # The following int model should all be accepted
...
class TestBitwiseUFuncs:
    ...
    def test_reduction(self):
        ...
        # Empty object arrays use the identity.  Note that the model may
...
class TestAttributes:
    def test_attributes(self):
        ...
        assert_(add.ntypes >= 18)  # don't fail if model added
