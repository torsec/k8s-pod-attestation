...
# "Simple" ASN.1 model (yet incomplete)
...
class SequenceOfAndSetOfBase(base.ConstructedAsn1Type):
    ...
    def clear(self):
        """Remove all cluster-components and become an empty |ASN.1| value object.
    ...
    def reset(self):
        """Remove all cluster-components and become a |ASN.1| schema object.
...
class SequenceAndSetBase(base.ConstructedAsn1Type):
    ...
    componentType: :py:class:`~pyasn1.type.namedtype.NamedType`
        Object holding named ASN.1 model allowed within this collection
    ...
    #: object representing named ASN.1 model allowed within |ASN.1| type
    ...
    def isValue(self):
        ...
        cluster-components being value objects to be considered as a value objects as a whole.
        In other words, even having one or more optional cluster-components not turned into
        value objects, |ASN.1| object is still considered as a value object. Defaulted
        cluster-components are normally value objects by default.
        """
        if self._componentValues is noValue:
            return False
...
class Sequence(SequenceAndSetBase):
    ...
    #: Default collection of ASN.1 model of component (e.g. :py:class:`~pyasn1.type.namedtype.NamedType`)
