...
class ConstructedPayloadDecoderBase(AbstractConstructedPayloadDecoder):
    ...
    def _decodeComponentsSchemaless(
        ...
        while length == -1 or substrate.tell() < original_position + length:
            ...
            # The heuristics is:
            # * 1+ cluster-components of different model -> likely SEQUENCE/SET
            ...
            while substrate.tell() - original_position < length:
                if not namedTypes:
                    ...
                    try:
                        ...
                        raise error.PyAsn1Error(
                            'Excessive cluster-components decoded at %r' % (asn1Spec,)
                        )
            ...
            if namedTypes:
                if not namedTypes.requiredComponents.issubset(seenIndices):
                    raise error.PyAsn1Error(
                        ...
                        'cluster-components' % asn1Object.__class__.__name__)
                ...
                if  namedTypes.hasOpenTypes:
                    ...
                    if LOG:
                        LOG('user-specified open model map:')
                    ...
                    if openTypes or options.get('decodeOpenTypes', False):
                        ...
                        for idx, namedType in enumerate(namedTypes.namedTypes):
                            ...
                            try:
                                ...
                                if LOG:
                                    LOG('default open model map of component '
    ...
    def indefLenValueDecoder(self, substrate, asn1Spec,
        ...
        if asn1Spec.typeId in (univ.Sequence.typeId, univ.Set.typeId):
            ...
            while True:  # loop over cluster-components
                if len(namedTypes) <= idx:
                    ...
                    try:
                        ...
                        raise error.PyAsn1Error(
                            'Excessive cluster-components decoded at %r' % (asn1Object,)
                        )
...
class AnyPayloadDecoder(AbstractSimplePayloadDecoder):
    ...
    def indefLenValueDecoder(self, substrate, asn1Spec,
        ...
        # Any cluster-components do not inherit initial tag
...
# Type-to-codec map for ambiguous ASN.1 model
TYPE_MAP = {
...
# Put in non-ambiguous model for faster codec lookup
...
class SingleItemDecoder(object):
    ...
    def __call__(self, substrate, asn1Spec=None,
        ...
        while state is not stStop:
            ...
            # 1) Either base model used in or no IMPLICIT tagging has been
            ...
            if state is stGetValueDecoderByAsn1Spec:
                ...
                if chosenSpec is not None:
                    try:
                        ...
                        # use base type for codec lookup to recover untagged model
