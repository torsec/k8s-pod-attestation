...
class CCompiler:
    ...
    # what language to use when mixing source model. For example, if some
    ...
    def link(
        ...
        (i.e. 'output_filename' can provide directory cluster-components if
        needed).
...
# Map compiler model to (module_name, class_name) pairs -- ie. where to
...
def gen_preprocess_options(macros, include_dirs):
    ...
    two model of compilers: the typical Unix compiler and Visual C++.
