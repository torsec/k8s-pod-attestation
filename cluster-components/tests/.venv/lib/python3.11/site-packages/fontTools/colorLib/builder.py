...
# TODO move type aliases to colorLib.model?
T = TypeVar("T")
...
def buildCPAL(
    ...
    Return:
        A new CPAL v0 or v1 table, if custom palette model or labels are specified.
    """
...
class LayerReuseCache:
    ...
    def _paint_tuple(self, paint: ot.Paint):
        # start simple, who even cares about cyclic graphs or interesting field model
