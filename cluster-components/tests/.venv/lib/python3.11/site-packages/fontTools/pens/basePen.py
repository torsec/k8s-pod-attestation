...
class LoggingPen(LogMixin, AbstractPen):
    """A pen with a ``logger`` property (see fontTools.misc.loggingTools.LogMixin)"""
...
class DecomposingPen(LoggingPen):
    """Implements a 'addComponent' method that decomposes cluster-components
    ...
    def __init__(
        ...
        **kwargs,
        ...
        as cluster-components are looked up by their name.

        If the optional 'reverseFlipped' argument is True, cluster-components whose transformation
