...
require (
	...
	github.com/torsec/k8s-pod-attestation/pkg/crypto v0.0.0-20250303105839-6bf3cd71b0c7
	github.com/torsec/k8s-pod-attestation/pkg/model v0.0.0-20250303105839-6bf3cd71b0c7
)
