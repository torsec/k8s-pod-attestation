...
require (
	...
	github.com/torsec/k8s-pod-attestation/pkg/crypto v0.0.0-20250327153511-9b38c322dd0e
	...
	github.com/torsec/k8s-pod-attestation/pkg/tpm v0.0.0-20250327165150-9014ef207988
)
