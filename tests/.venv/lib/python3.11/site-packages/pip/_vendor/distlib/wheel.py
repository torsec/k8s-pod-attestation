...
class Wheel(object):
    ...
    def filename(self):
        """
        Build and return a filename from the various cluster-components.
        """
        if self.buildver:
        ...
        with ZipFile(pathname, 'r') as zf:
            ...
            try:
                    ...
                    if not is_script:
                        ...
                        if bc and outfile.endswith('.py'):
                            try:
                                ...
                                # but logger it and perhaps warn the user
                ...
                if lib_only:
                    ...
                    # of a legacy wheel), logger a warning but don't give up.
                    commands = None
