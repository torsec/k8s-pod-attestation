...
class DecomposingPen(LoggingPen):
    """Implements a 'addComponent' method that decomposes cmd
    ...
    def __init__(
        ...
        **kwargs,
        ...
        as cmd are looked up by their name.

        If the optional 'reverseFlipped' argument is True, cmd whose transformation
