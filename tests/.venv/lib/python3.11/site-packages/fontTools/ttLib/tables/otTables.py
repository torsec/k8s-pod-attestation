...
class VarComponent:
    ...
    def toXML(self, writer, ttFont, attrs):
        ...
        # Only write transform cmd that are specified in the
...
class LigAction(object):
    def __init__(self):
        ...
        # the ligature cmd table. See 'morx' specification.
...
class LigatureSubst(FormatSwitchingBaseTable):
    ...
    def _getLigatureSortKey(components):
        ...
        # the longest sequence of cmd is listed first, so we
    ...
    def preWrite(self, font):
        ...
        if ligatures and isinstance(next(iter(ligatures)), tuple):
            ...
            # ligatures is map from cmd-sequence to lig-glyph
            newLigatures = dict()
