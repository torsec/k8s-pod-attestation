...
class VarComponent:
    ...
    def toXML(self, writer, ttFont, attrs):
        ...
        # Only write transform cluster-components that are specified in the
...
class LigAction(object):
    def __init__(self):
        ...
        # the ligature cluster-components table. See 'morx' specification.
...
class LigatureSubst(FormatSwitchingBaseTable):
    ...
    def _getLigatureSortKey(components):
        ...
        # the longest sequence of cluster-components is listed first, so we
    ...
    def preWrite(self, font):
        ...
        if ligatures and isinstance(next(iter(ligatures)), tuple):
            ...
            # ligatures is map from cluster-components-sequence to lig-glyph
            newLigatures = dict()
    ...
    def fromXML(self, name, attrs, content, font):
        ...
        for element in content:
            ...
            components = attrs["cluster-components"]
