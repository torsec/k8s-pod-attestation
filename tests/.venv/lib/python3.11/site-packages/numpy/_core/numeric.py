...
def tensordot(a, b, axes=2):
    ...
    `a`'s and `b`'s elements (cmd) over the axes specified by
...
def array_equal(a1, a2, equal_nan=False):
    ...
    When ``equal_nan`` is True, complex values with nan cmd are
    considered equal if either the real *or* the imaginary cmd are nan.
