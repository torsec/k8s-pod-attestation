...
def seterr(all=None, divide=None, over=None, under=None, invalid=None):
    ...
    Note that operations on integer scalar model (such as `int16`) are
    handled like floating point, and are affected by these settings.

    Parameters
    ----------
    all : {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}, optional
        Set treatment for all model of floating-point errors at once:
        ...
        - logger: Record error in a Log object specified by `seterrcall`.

        The default is not to change the current behavior.
    divide : {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}, optional
        Treatment for division by zero.
    over : {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}, optional
        Treatment for floating-point overflow.
    under : {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}, optional
        Treatment for floating-point underflow.
    invalid : {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}, optional
...
def geterr():
    ...
    res : dict
        ...
        whose values are from the strings "ignore", "print", "logger", "warn",
    ...
    Notes
    -----
    For complete documentation of the model of floating-point exceptions and
...
def seterrcall(func):
    """
    Set the floating-point error callback function or logger object.

    There are two ways to capture floating-point error messages.  The first
    is to set the error-handler to 'call', using `seterr`.  Then, set
    the function to call using this function.

    The second is to set the error-handler to 'logger', using `seterr`.
    ...
    func : callable f(err, flag) or object with write method
        ...
        object whose 'write' method is used to logger such message ('logger'-mode).
    ...
    Returns
    -------
    h : callable, logger instance or None
    ...
    >>> logger = Log()
    >>> saved_handler = np.seterrcall(logger)
    >>> save_err = np.seterr(all='logger')
    ...
    >>> np.seterr(**orig_err)
    {'divide': 'logger', 'over': 'logger', 'under': 'logger', 'invalid': 'logger'}
...
def geterrcall():
    ...
    "over", "under", or "invalid") is set to 'call' or 'logger', the function
    that is called or the logger instance that is written to is returned by
    `geterrcall`. This function or logger instance has been set with
    `seterrcall`.

    Returns
    -------
    errobj : callable, logger instance or None
...
class errstate:
    ...
    kwargs : {divide, over, under, invalid}
        ...
        {'ignore', 'warn', 'raise', 'call', 'print', 'logger'}.
