...
class TestScalarDiscovery:
    ...
    def test_scalar_coercion(self, scalar):
        ...
        # model. It includes some paths not directly related to `np.array`.
        ...
        for scalar in scalar_instances(times=False):
            ...
            if dtype.type == np.void:
               if scalar.dtype.fields is not None and dtype.fields is None:
                    ...
                    # Since the model are identical, SETITEM takes care of
...
class TestAsArray:
    ...
    def test_dtype_identity(self):
        ...
        # Check the same logic for a pair of C model whose equivalence may vary
