...
class MachArLike:
    ...
    def __init__(self, ftype, *, eps, epsneg, huge, tiny,
        ...
        # Parameter model same as for discovered MachAr object.
...
def _get_machar(ftype):
    ...
    various known floating point model, then, if none match, attempting to
...
def _discovered_machar(ftype):
    """ Create MachAr instance with found information on float model
...
class finfo:
    ...
    Machine limits for floating point model.
    ...
    dtype : dtype
        ...
        real and complex cluster-components.
    eps : float
    ...
    See Also
    --------
    iinfo : The equivalent for integer data model.
    ...
    standard [1]_, NumPy floating point model make use of subnormal numbers to
    fill the gap between 0 and ``smallest_normal``. However, subnormal numbers
    may have significantly reduced precision [2]_.

    This function can also be used for complex data model as well. If used,
    the output will be the same as the corresponding real float type
    (e.g. numpy.finfo(numpy.csingle) is the same as numpy.finfo(numpy.single)).
    However, the output is true for the real and imaginary cluster-components.
    ...
    def smallest_normal(self):
        ...
        # platform dependent for longdouble model.
...
class iinfo:
    ...
    Machine limits for integer model.
    ...
    See Also
    --------
    finfo : The equivalent for floating point data model.
