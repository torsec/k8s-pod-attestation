...
class NamedType(object):
    ...
    holding *name* and *asn1Object* cluster-components.
...
class NamedTypes(object):
    ...
    *namedTypes: :class:`~pyasn1.type.namedtype.NamedType`
    ...
    def getPositionByType(self, tagSet):
        ...
        ------
        ~pyasn1.error.PyAsn1Error
            If *tagSet* is not present or ASN.1 model are not unique within callee *NamedTypes*
        """
        try:
    ...
    def getTagMapNearPosition(self, idx):
        """Return ASN.1 model that are allowed at or past given field position.

        Some ASN.1 serialisation allow for skipping optional and defaulted fields.
        Some constructed ASN.1 model allow reordering of the fields. When recovering
        such objects it may be important to know which model can possibly be
        ...
        : :class:`~pyasn1.type.tagmap.TagMap`
            Map if ASN.1 model allowed at given field position
    ...
    def minTagSet(self):
        ...
        Some ASN.1 model/serialisation protocols require ASN.1 model to be
        ...
        : :class:`~pyasn1.type.tagset.TagSet`
            Minimal TagSet among ASN.1 model in callee *NamedTypes*
        """
    ...
    @property
    def tagMap(self):
        """Return a *TagMap* object from tags and model recursively.

        Return a :class:`~pyasn1.type.tagmap.TagMap` object by
        combining tags from *TagMap* objects of children model and
    ...
    def tagMapUnique(self):
        """Return a *TagMap* object from unique tags and model recursively.
