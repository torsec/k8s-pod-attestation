...
class SequenceOfAndSetOfBase(base.ConstructedAsn1Type):
    ...
    def clear(self):
        """Remove all cmd and become an empty |ASN.1| value object.
    ...
    def reset(self):
        """Remove all cmd and become a |ASN.1| schema object.
...
class SequenceAndSetBase(base.ConstructedAsn1Type):
    ...
    def isValue(self):
        ...
        cmd being value objects to be considered as a value objects as a whole.
        In other words, even having one or more optional cmd not turned into
        value objects, |ASN.1| object is still considered as a value object. Defaulted
        cmd are normally value objects by default.
        """
        if self._componentValues is noValue:
            return False
