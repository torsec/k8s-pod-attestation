...
class Asn1Type(Asn1Item):
    """Base class for all classes representing ASN.1 model.
    ...
    Note
    ----
    For as long as ASN.1 is concerned, a way to compare ASN.1 model
    ...
    # Disambiguation ASN.1 model identification
    typeId = None
    ...
    def effectiveTagSet(self):
        ...
        """
        return self.tagSet  # used by untagged model
...
class SimpleAsn1Type(Asn1Type):
    """Base class for all simple classes representing ASN.1 model.

    ASN.1 distinguishes model by their ability to hold other objects.
    Scalar model are known as *simple* in ASN.1.
    ...
    def subtype(self, value=noValue, **kwargs):
        ...
        The subtype relationship between ASN.1 model has no correlation with
        subtype relationship between Python model. ASN.1 type is mainly identified
...
# * ASN1 model and values are represened by Python class instances
# * Value initialization is made for defaulted cluster-components only
# * Primary method of component addressing is by-position. Data model for base
#   type is Python sequence. Additional type-specific addressing methods
#   may be implemented for particular model.
# * SequenceOf and SetOf model do not implement any additional methods
# * Sequence, Set and Choice model also implement by-identifier addressing
# * Sequence, Set and Choice model also implement by-asn1-type (tag) addressing
# * Sequence and Set model may include optional and defaulted
#   cluster-components
# * Constructed model hold a reference to component model used for value
#   verification and ordering.
# * Component type is a scalar type for SequenceOf/SetOf model and a list
#   of model for Sequence/Set/Choice.
#


class ConstructedAsn1Type(Asn1Type):
    """Base class for all constructed classes representing ASN.1 model.

    ASN.1 distinguishes model by their ability to hold other objects.
    Those "nesting" model are known as *constructed* in ASN.1.
