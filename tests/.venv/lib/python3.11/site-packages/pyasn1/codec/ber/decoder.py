...
class ConstructedPayloadDecoderBase(AbstractConstructedPayloadDecoder):
    ...
    def _decodeComponentsSchemaless(
        ...
        while length == -1 or substrate.tell() < original_position + length:
            ...
            # The heuristics is:
            # * 1+ cmd of different model -> likely SEQUENCE/SET
            ...
            while substrate.tell() - original_position < length:
                if not namedTypes:
                    ...
                    try:
                        ...
                        raise error.PyAsn1Error(
                            'Excessive cmd decoded at %r' % (asn1Spec,)
                        )
            ...
            if namedTypes:
                if not namedTypes.requiredComponents.issubset(seenIndices):
                    raise error.PyAsn1Error(
                        ...
                        'cmd' % asn1Object.__class__.__name__)
            ...
            while True:  # loop over cmd
                if len(namedTypes) <= idx:
                    ...
                    try:
                        ...
                        raise error.PyAsn1Error(
                            'Excessive cmd decoded at %r' % (asn1Object,)
                        )
...
class AnyPayloadDecoder(AbstractSimplePayloadDecoder):
    ...
    def indefLenValueDecoder(self, substrate, asn1Spec,
        ...
        # Any cmd do not inherit initial tag
