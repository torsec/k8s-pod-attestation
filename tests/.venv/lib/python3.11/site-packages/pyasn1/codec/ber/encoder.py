...
class SequenceEncoder(AbstractItemEncoder):
    ...
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        ...
        if LOG:
            LOG('%sencoding empty OPTIONAL cmd' % (
...
class ChoiceEncoder(AbstractItemEncoder):
    def encodeValue(self, value, asn1Spec, encodeFun, **options):
        if asn1Spec is None:
            ...
            if len(names) != 1:
                raise error.PyAsn1Error('%s cmd for Choice at %r' % (len(names) and 'Multiple ' or 'None ', value))
...
#: walks all its cmd recursively and produces a BER octet stream.
#:
#: Parameters
#: ----------
