...
class SetEncoder(encoder.SetEncoder):
    ...
    def _componentSortKey(componentAndType):
        """Sort SET cluster-components by tag
            ...
            if asn1Spec is None:
                ...
                if len(names) != 1:
                    raise error.PyAsn1Error(
                        '%s cluster-components for Choice at %r' % (len(names) and 'Multiple ' or 'None ', component))
...
#: walks all its cluster-components recursively and produces a DER octet stream.
#:
#: Parameters
#: ----------
