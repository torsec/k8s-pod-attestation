...
#: walks all its cluster-components recursively and produces a Python built-in type or a tree
#: of those.
#:
#: One exception is that instead of :py:class:`dict`, the :py:class:`OrderedDict`
#: is used to preserve ordering of the cluster-components in ASN.1 SEQUENCE.
#:
#: Parameters
#: ----------
...
#: Examples
#: --------
#: Encode ASN.1 value object into native Python model
#:
#: .. code-block:: pycon
#:
